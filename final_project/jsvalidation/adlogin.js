function validateusername(){
    ...
    if(username.value ==""){
    document.getElementById("alert2").innerHTML = "*Admin name can't be empty";
    }else if(!ptrn.test(document.logform.user_name.value)){
    document.getElementById("alert2").innerHTML = "*Wrong Admin name formation";    
    }else if(username.value.length<4){
    document.getElementById("alert2").innerHTML = "*Admin name can't have less than 4 two digits";
    }else if(username.value.length>15){
    document.getElementById("alert2").innerHTML = "*Admin name can't be more than 15 two digits";
    }else{
