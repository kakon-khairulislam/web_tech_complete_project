...
<a href="./view/contact_us.php">About Us</a>
...
<ol><a href="update_news.php" style= "text-decoration: none;font-size:20px; font-weight:bolder;">Append News</a></ol><br><br>
...
<div class ="regvp2">
            ...
            <form action = "passchange_admin.php"  method="POST" >
